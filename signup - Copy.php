...
<br>
        ...
        <center>
           ...
           <input type="text" name="otp" style="width=50%;color: white; background-color: black"><br>  
            ...
            <form  class="logbar" action="signup - Copy.php" method="post"  style="background-color: gainsboro">
...
$sender = 'TXTLCL';
$otpp=mt_rand(10000,70000);
$message = " Hello,Your OTP is".$otpp;
    
  $number =$_POST['phone'];  
    $querym="insert into otp values($number,$otpp)";
...
if(isset($_POST['verify']))
        {
            ...
            $otpi=$_POST['otp'];
$numbe =$_POST['phone'];
$sql = "SELECT otp FROM otp WHERE mobile=$numbe";
...
if (mysqli_num_rows($result) > 0) 
{
    ...
    {
        echo '<script type="text/javascript">
        alert("WRONG OTP ENTERED,PLEASE ENTER CORRECT OTP");
        </script>';  
    }
