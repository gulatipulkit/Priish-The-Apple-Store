...
<br>
        ...
        <div>
       <center>
            <form  class="logbar"  method="post" action="email.php ">
                <h1>Email-Verification</h1>
                <img src="no_user_logo.jpeg " style="width: 150px; border-radius: 50px; align-content: center; margin: 10px;"><br> 
             
            <b>Email</b>
            <input   type="email" name="email" placeholder="Enter your Email"><br><h3></h3>
...
$sstr='zawrxstcdryvtfubygnuhjkjbhgZWRDFBJHGJMH4535465%_/1212#$%&*^%$##';
$token=str_shuffle($token);


$querym="insert into otp values($email,'0',$token)";
    $query_run=mysqli_query($con,$querym);
$mail=new PHPMailer();
/*$mail->setFrom(address:'priish@pulkit.com');*/
$mail->addAddress($email);
$mail->'please verify email';
$mail->isHTML(isHTML:true);
$email->Body="
please click on link below:<br><br>
<a href='http://codingpassiveincome.com/'</a>
";
